...
import { FolderOpen, ListTodo, BookOpen, CalendarDays, Search, Plus, ArrowLeft, Settings2, LogOut, LockKeyhole, ArrowRight, LoaderCircle, RefreshCw, Menu, X, Download, ShieldCheck, CircleHelp, Sprout, Activity, Check } from 'lucide-react'
...
export default function App() {
  ...
  const props = {data,search,onEdit:edit,onSelect:selectProject,onNavigate:navigate,onSave:quickSave,onCreate:save,projectId}
