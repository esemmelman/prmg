...
import { FolderOpen, ListTodo, BookOpen, CalendarDays, Search, Plus, ChevronDown, ArrowLeft, Settings2, LogOut, LockKeyhole, ArrowRight, LoaderCircle, RefreshCw, Menu, X, Download, ShieldCheck, CircleHelp, Sprout, Activity, Check } from 'lucide-react'
...
const nav = [ ['projects','Projects',FolderOpen], ['tasks','Tasks',ListTodo], ['knowledge','Knowledge base',BookOpen], ['timeline','Timeline',CalendarDays] ]
